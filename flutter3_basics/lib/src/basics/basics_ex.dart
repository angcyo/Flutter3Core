...
extension ObjectEx on Object {
  ...
  Widget text({
    ...
    final highlightHandle =
        !isNullOrEmpty(highlight) || !isNullOrEmpty(highlightList);
    if (highlightHandle) {
      highlightTextStyle ??= innerTextStyle?.copyWith(
    ...
    debugger(when: debugLabel != null && highlightHandle);
...
extension StringEx on String {
  ...
  String? orNull2([bool enable = true]) => enable && isEmpty ? null : this;
  ...
  bool isValidAccount({
    ...
    int? maxLength = 30,
      ...
      isMatch(regex ?? '^[a-zA-Z0-9_-]{${minLength - 1},${maxLength ?? ""}}\$');
