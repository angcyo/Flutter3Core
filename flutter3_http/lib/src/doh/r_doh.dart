...
/// DNS over HTTPS (DoH)
///
/// IANA-managed Reserved Domains - IANA 管理的保留域名
/// https://www.iana.org/domains/reserved
///
/// Special-Use Domain Names - 特殊用途域名
...
/// alt. | [RFC9476]
/// 6tisch.arpa. | [RFC9031]
/// eap.arpa. | [RFC-ietf-emu-eap-arpa-10]
/// eap-noob.arpa. (DEPRECATED) | [RFC9140][RFC-ietf-emu-eap-arpa-10]
/// home.arpa. | [RFC8375]
...
/// 170.0.0.192.in-addr.arpa. | [RFC8880]
/// 171.0.0.192.in-addr.arpa. | [RFC8880]
/// 168.192.in-addr.arpa. | [RFC6761]
/// 8.e.f.ip6.arpa. | [RFC6762]
/// 9.e.f.ip6.arpa. | [RFC6762]
/// a.e.f.ip6.arpa. | [RFC6762]
/// b.e.f.ip6.arpa. | [RFC6762]
/// ipv4only.arpa. | [RFC8880]
/// resolver.arpa. | [RFC9462]
/// service.arpa. | [RFC9665]
/// example. | [RFC6761]
/// example.com. | [RFC6761]
/// example.net. | [RFC6761]
/// example.org. | [RFC6761]
