...
class CanvasDelegate with Diagnosticable implements TickerProvider {
  ...
  /// - [addCanvasListenerList]
  @api
  void addCanvasListenerList(Iterable<CanvasListener>? listenerList) {
    if (listenerList == null) {
      return;
    }
    canvasListeners.addAll(listenerList);
  }

  /// 移除画布监听
  /// - [removeCanvasListener]
  /// - [removeCanvasListenerList]
  @api
  ...
  /// - [removeCanvasListenerList]
  @api
  void removeCanvasListenerList(Iterable<CanvasListener>? listenerList) {
    if (listenerList == null) {
      return;
    }
    canvasListeners.removeAll(listenerList);
  }
  ...
  /// [overlayComponent]
  void dispatchCanvasOverlayComponentChanged(
  ...
  bool dispatchKeyEvent(
    ...
    _eachCanvasListener((element) {
      handle =
          element.onKeyEventAction?.call(this, render, event, handler) == true;
      if (handle) {
        return true;
      }
    }, reverse: true);
